...
**Template (CloudFormation, V2)** — S3, RDS, ALB, CloudTrail, KMS, VPC/Flow Logs, Lambda, DynamoDB, Security Groups, CloudWatch Logs, SQS, API Gateway, EKS. Full list: [docs/CF_RULES.md](docs/CF_RULES.md).
